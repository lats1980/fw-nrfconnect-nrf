...
#define IEEE802154_PHY_HEADER_SIZE            2
...
#if (CONFIG_OPENTHREAD_OVER_DECTNR_DEFAULT_TX_MCS == 4)
#define DECT_MAX_TBS      5600
#elif (CONFIG_OPENTHREAD_OVER_DECTNR_DEFAULT_TX_MCS == 3)
#define DECT_MAX_TBS      5280
#elif (CONFIG_OPENTHREAD_OVER_DECTNR_DEFAULT_TX_MCS == 2)
#define DECT_MAX_TBS      5536
#elif (CONFIG_OPENTHREAD_OVER_DECTNR_DEFAULT_TX_MCS == 1)
#define DECT_MAX_TBS      3960
#elif (CONFIG_OPENTHREAD_OVER_DECTNR_DEFAULT_TX_MCS == 0)
