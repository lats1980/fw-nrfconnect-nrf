...
/**
 * @def OPENTHREAD_CONFIG_HARDWARE_AES_CCM
 *
 * Define to 1 to enable hardware AES CCM logic.
 *
 */
#ifdef CONFIG_OPENTHREAD_HARDWARE_AES_CCM
#define OPENTHREAD_CONFIG_HARDWARE_AES_CCM CONFIG_OPENTHREAD_HARDWARE_AES_CCM
#endif
