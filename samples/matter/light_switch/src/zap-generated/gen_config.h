...
#define EMBER_AF_IDENTIFY_CLUSTER_SERVER_ENDPOINT_COUNT (12)
...
#define EMBER_AF_DESCRIPTOR_CLUSTER_SERVER_ENDPOINT_COUNT (13)
#define EMBER_AF_BINDING_CLUSTER_SERVER_ENDPOINT_COUNT (4)
