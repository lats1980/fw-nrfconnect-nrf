...
#define EMBER_AF_GROUPS_CLUSTER_SERVER_ENDPOINT_COUNT (5)
#define EMBER_AF_SCENES_CLUSTER_SERVER_ENDPOINT_COUNT (5)
#define EMBER_AF_ON_OFF_CLUSTER_SERVER_ENDPOINT_COUNT (5)
